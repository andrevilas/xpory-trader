# Runbook: Export policy - excluir categoria

## Objetivo
Validar que uma categoria especifica e removida do export (todas as demais permanecem).
...
- CATEGORY_ID para excluir: `15` (Alimentacao, activeCount=61)
...
- Exporter: `total=1968`.
- Importer: `summary.totalOffersDiscovered=1647` e `summary.eligibleOffers=1647`.
