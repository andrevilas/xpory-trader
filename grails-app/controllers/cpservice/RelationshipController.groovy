...
class RelationshipController {
    ...
    private Map toJson(Relationship relationship) {
        ...
        [
                ...
                approvalMode        : relationship.approvalMode,
                approval_mode       : relationship.approvalMode,
                manualApprovalAboveAmount   : relationship.manualApprovalAboveAmount,
                manual_approval_above_amount: relationship.manualApprovalAboveAmount,
                manualApprovalAboveQty      : relationship.manualApprovalAboveQty,
                manual_approval_above_qty   : relationship.manualApprovalAboveQty,
                manualApprovalOnFirstTrade  : relationship.manualApprovalOnFirstTrade,
                manual_approval_on_first_trade: relationship.manualApprovalOnFirstTrade,
                manualApprovalOnImbalance   : relationship.manualApprovalOnImbalance,
                manual_approval_on_imbalance: relationship.manualApprovalOnImbalance,
