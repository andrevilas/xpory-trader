# Runbook: Export policy - unica categoria

## Objetivo
Validar que apenas uma categoria especifica e exportada.
...
- CATEGORY_ID com ofertas: `15` (Alimentacao, activeCount=61)
...
SET export_policy='{"min_created_at":"2000-01-01T00:00:00Z","include_categories":["15"],"exclude_categories":[],"entity_allowlist":[],"entity_blocklist":[],"enabled":true}'
...
- Exporter: `total=61`.
- Importer: `summary.totalOffersDiscovered=48` e `summary.eligibleOffers=48`.
