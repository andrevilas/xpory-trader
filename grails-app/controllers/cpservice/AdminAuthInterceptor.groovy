...
class AdminAuthInterceptor {
    ...
    AdminAuthInterceptor() {
        ...
        match(controller: 'exportMetadata', action: 'categories')
        match(controller: 'exportMetadata', action: 'syncCategories')
        match(controller: 'exportMetadata', action: 'entities')
        match(controller: 'exportMetadata', action: 'syncEntities')
